...
On peut enfin obtenir une version \emph{\og textuelle \fg} via la macro \macro{txtfuncdef} qui ne s'utilise pas en mode mathématique où \prefix{txt} est pour \prefix{texte}.
Ici aussi on peut omettre des ensembles.
